...
function Navbar() {
  ...
  return (
    <div className='text-white max-w-[1250px] p-5 mx-auto border-b border-gray-800 '>
        ...
        {/* overlay black */}
        {nav?<div className='w-full h-screen absolute top-0 left-0 bg-black/80 z-[100]'></div> : null}
        
        <div className={nav?'bg-black w-[60%] h-screen absolute left-0 top-0 border-r border-gray-900 z-[100] duration-500 md:w-[30%]' : 'bg-black w-[60%] h-screen absolute left-[-100%] top-0 border-r border-gray-900 z-[100] duration-500'}>
